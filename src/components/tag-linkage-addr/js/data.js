// 数据来源 https://gitee.com/lblblib/amap-city-data/tree/master
let dataList = [
  {
    code: "410000",
    name: "河南省",
    children: [
      ...
      },
      {
        ...
        name: "济源市",
        children: [
          { code: "419001", name: "济源市坡头镇" },
          { code: "419001", name: "济源市梨林镇" },
          { code: "419001", name: "济源市思礼镇" },
          { code: "419001", name: "济源市大峪镇" },
          { code: "419001", name: "济源市五龙口镇" },
          { code: "419001", name: "济源市王屋镇" },
          { code: "419001", name: "济源市玉泉街道" },
          { code: "419001", name: "济源市轵城镇" },
          { code: "419001", name: "济源市济水街道" },
          { code: "419001", name: "济源市沁园街道" },
          { code: "419001", name: "济源市下冶镇" },
          { code: "419001", name: "济源市克井镇" },
          { code: "419001", name: "济源市天坛街道" },
          { code: "419001", name: "济源市邵原镇" },
          { code: "419001", name: "济源市北海街道" },
          { code: "419001", name: "济源市承留镇" },
        ],
      },
      {
        code: "410900",
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { code: "442000", name: "东升镇" },
          { code: "442000", name: "神湾镇" },
          { code: "442000", name: "火炬开发区街道" },
          { code: "442000", name: "小榄镇" },
          { code: "442000", name: "南朗镇" },
          { code: "442000", name: "古镇镇" },
          { code: "442000", name: "民众镇" },
          { code: "442000", name: "港口镇" },
          { code: "442000", name: "三乡镇" },
          { code: "442000", name: "石岐区街道" },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "可克达拉市",
        children: [
          { code: "659008", name: "长丰镇" },
          { code: "659008", name: "都拉塔口岸" },
          { code: "659008", name: "苇湖镇" },
          { code: "659008", name: "兵团六十七团" },
          { code: "659008", name: "榆树庄镇" },
          { code: "659008", name: "兵团六十六团" },
        ],
      },
      {
        code: "659001",
        name: "石河子市",
        children: [
          { code: "659001", name: "兵团一五二团" },
          { code: "659001", name: "向阳街道" },
          { code: "659001", name: "红山街道" },
          { code: "659001", name: "东城街道" },
          { code: "659001", name: "石河子镇" },
          { code: "659001", name: "老街街道" },
          { code: "659001", name: "新城街道" },
          { code: "659001", name: "北泉镇" },
        ],
      },
      {
        code: "659005",
        name: "北屯市",
        children: [
          { code: "659005", name: "北屯镇" },
          { code: "659005", name: "丰庆镇" },
          { code: "659005", name: "双渠镇" },
          { code: "659005", name: "海川镇" },
        ],
      },
      {
        code: "654200",
      ...
      },
      {
        ...
        name: "双河市",
        children: [
          { code: "659007", name: "兵团八十九团" },
          { code: "659007", name: "博河镇" },
          { code: "659007", name: "石峪镇" },
          { code: "659007", name: "双乐镇" },
          { code: "659007", name: "双桥镇" },
        ],
      },
      {
        code: "659006",
        name: "铁门关市",
        children: [
          { code: "659006", name: "博古其镇" },
          { code: "659006", name: "双丰镇" },
        ],
      },
      {
        code: "659009",
        name: "昆玉市",
        children: [
          { code: "659009", name: "乌鲁克萨依乡" },
          { code: "659009", name: "兵团二二四团" },
          { code: "659009", name: "昆牧镇" },
          { code: "659009", name: "昆泉镇" },
          { code: "659009", name: "老兵镇" },
          { code: "659009", name: "普恰克其乡" },
          { code: "659009", name: "博斯坦乡" },
          { code: "659009", name: "阔依其乡" },
          { code: "659009", name: "奴尔乡" },
          { code: "659009", name: "乌尔其乡" },
          { code: "659009", name: "喀拉喀什镇" },
        ],
      },
      {
        code: "659004",
        name: "五家渠市",
        children: [
          { code: "659004", name: "梧桐镇" },
          { code: "659004", name: "军垦路街道" },
          { code: "659004", name: "人民路街道" },
          { code: "659004", name: "兵团一零一团" },
          { code: "659004", name: "蔡家湖镇" },
          { code: "659004", name: "青湖路街道" },
        ],
      },
      {
        code: "652300",
      ...
      },
      {
        ...
        name: "阿拉尔市",
        children: [
          { code: "659002", name: "幸福路街道" },
          { code: "659002", name: "阿拉尔农场" },
          { code: "659002", name: "兵团第一师幸福农场" },
          { code: "659002", name: "工业园区" },
          { code: "659002", name: "兵团七团" },
          { code: "659002", name: "花桥镇" },
          { code: "659002", name: "青松路街道" },
          { code: "659002", name: "托喀依乡" },
          { code: "659002", name: "兵团第一师水利水电工程处" },
          { code: "659002", name: "兵团八团" },
          { code: "659002", name: "中心监狱" },
          { code: "659002", name: "兵团第一师塔里木灌区水利管理处" },
          { code: "659002", name: "金杨镇" },
          { code: "659002", name: "兵团十团" },
          { code: "659002", name: "金银川路街道" },
          { code: "659002", name: "兵团十六团" },
          { code: "659002", name: "兵团十二团" },
          { code: "659002", name: "南口街道" },
          { code: "659002", name: "幸福镇" },
        ],
      },
      {
        code: "659003",
        name: "图木舒克市",
        children: [
          { code: "659003", name: "兵团四十九团" },
          { code: "659003", name: "兵团图木舒克市永安坝" },
          { code: "659003", name: "兵团五十一团" },
          { code: "659003", name: "前海街道" },
          { code: "659003", name: "兵团图木舒克市喀拉拜勒镇" },
          { code: "659003", name: "永安坝街道" },
          { code: "659003", name: "齐干却勒街道" },
          { code: "659003", name: "兵团五十三团" },
          { code: "659003", name: "夏河镇" },
          { code: "659003", name: "兵团四十四团" },
        ],
      },
      {
        code: "650500",
      ...
      },
      {
        ...
        name: "胡杨河市",
        children: [
          { code: "659010", name: "兵团一三零团" },
          { code: "659010", name: "五五新镇街道" },
          { code: "659010", name: "兵团一二八团" },
          { code: "659010", name: "兵团一二九团" },
        ],
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "天门市",
        children: [
          { code: "429006", name: "胡市镇" },
          { code: "429006", name: "多祥镇" },
          { code: "429006", name: "黄潭镇" },
          { code: "429006", name: "沉湖管委会" },
          { code: "429006", name: "干驿镇" },
          { code: "429006", name: "马湾镇" },
          { code: "429006", name: "横林镇" },
          { code: "429006", name: "蒋湖农场" },
          { code: "429006", name: "小板镇" },
          { code: "429006", name: "多宝镇" },
          { code: "429006", name: "岳口镇" },
          { code: "429006", name: "蒋场镇" },
          { code: "429006", name: "石家河镇" },
          { code: "429006", name: "佛子山镇" },
          { code: "429006", name: "彭市镇" },
          { code: "429006", name: "九真镇" },
          { code: "429006", name: "侨乡街道开发区" },
          { code: "429006", name: "竟陵街道" },
          { code: "429006", name: "麻洋镇" },
          { code: "429006", name: "杨林街道" },
          { code: "429006", name: "汪场镇" },
          { code: "429006", name: "白茅湖农场" },
          { code: "429006", name: "拖市镇" },
          { code: "429006", name: "张港镇" },
          { code: "429006", name: "渔薪镇" },
          { code: "429006", name: "皂市镇" },
          { code: "429006", name: "卢市镇" },
          { code: "429006", name: "净潭乡" },
        ],
      },
      {
        code: "420800",
      ...
      },
      {
        ...
        name: "潜江市",
        children: [
          { code: "429005", name: "积玉口镇" },
          { code: "429005", name: "泰丰街道" },
          { code: "429005", name: "广华街道" },
          { code: "429005", name: "周矶管理区" },
          { code: "429005", name: "潜江经济开发区" },
          { code: "429005", name: "高场街道" },
          { code: "429005", name: "周矶街道" },
          { code: "429005", name: "总口管理区" },
          { code: "429005", name: "运粮湖管理区" },
          { code: "429005", name: "王场镇" },
          { code: "429005", name: "园林街道" },
          { code: "429005", name: "白鹭湖管理区" },
          { code: "429005", name: "竹根滩镇" },
          { code: "429005", name: "渔洋镇" },
          { code: "429005", name: "熊口镇" },
          { code: "429005", name: "后湖管理区" },
          { code: "429005", name: "熊口管理区" },
          { code: "429005", name: "江汉石油管理局" },
          { code: "429005", name: "张金镇" },
          { code: "429005", name: "杨市街道" },
          { code: "429005", name: "高石碑镇" },
          { code: "429005", name: "老新镇" },
          { code: "429005", name: "浩口镇" },
          { code: "429005", name: "龙湾镇" },
          { code: "429005", name: "浩口原种场" },
        ],
      },
      {
        code: "421200",
      ...
      },
      {
        ...
        name: "神农架林区",
        children: [
          { code: "429021", name: "木鱼镇" },
          { code: "429021", name: "下谷坪土家族乡" },
          { code: "429021", name: "新华镇" },
          { code: "429021", name: "九湖镇" },
          { code: "429021", name: "宋洛乡" },
          { code: "429021", name: "松柏镇" },
          { code: "429021", name: "红坪镇" },
          { code: "429021", name: "阳日镇" },
        ],
      },
      {
        code: "429004",
        name: "仙桃市",
        children: [
          { code: "429004", name: "畜禽良种场" },
          { code: "429004", name: "工业园区" },
          { code: "429004", name: "沙湖镇" },
          { code: "429004", name: "豆河镇" },
          { code: "429004", name: "通海口镇" },
          { code: "429004", name: "长倘口镇" },
          { code: "429004", name: "胡场镇" },
          { code: "429004", name: "五湖渔场" },
          { code: "429004", name: "干河街道" },
          { code: "429004", name: "杨林尾镇" },
          { code: "429004", name: "西流河镇" },
          { code: "429004", name: "赵西垸林场" },
          { code: "429004", name: "九合垸原种场" },
          { code: "429004", name: "彭场镇" },
          { code: "429004", name: "龙华山街道" },
          { code: "429004", name: "沔城回族镇" },
          { code: "429004", name: "沙湖原种场" },
          { code: "429004", name: "陈场镇" },
          { code: "429004", name: "郑场镇" },
          { code: "429004", name: "郭河镇" },
          { code: "429004", name: "沙嘴街道" },
          { code: "429004", name: "排湖风景区" },
          { code: "429004", name: "毛嘴镇" },
          { code: "429004", name: "张沟镇" },
          { code: "429004", name: "三伏潭镇" },
        ],
      },
      {
        code: "422800",
    ...
    children: [
      {
        ...
        name: "临高县",
        children: [
          { code: "469024", name: "南宝镇" },
          { code: "469024", name: "博厚镇" },
          { code: "469024", name: "和舍镇" },
          { code: "469024", name: "调楼镇" },
          { code: "469024", name: "东英镇" },
          { code: "469024", name: "国营加来农场" },
          { code: "469024", name: "多文镇" },
          { code: "469024", name: "波莲镇" },
          { code: "469024", name: "新盈镇" },
          { code: "469024", name: "国营红华农场" },
          { code: "469024", name: "临城镇" },
          { code: "469024", name: "皇桐镇" },
        ],
      },
      {
        code: "469021",
        name: "定安县",
        children: [
          { code: "469021", name: "新竹镇" },
          { code: "469021", name: "黄竹镇" },
          { code: "469021", name: "国营中瑞农场" },
          { code: "469021", name: "富文镇" },
          { code: "469021", name: "岭口镇" },
          { code: "469021", name: "定城镇" },
          { code: "469021", name: "雷鸣镇" },
          { code: "469021", name: "国营南海农场" },
          { code: "469021", name: "翰林镇" },
          { code: "469021", name: "龙门镇" },
          { code: "469021", name: "龙河镇" },
          { code: "469021", name: "国营金鸡岭农场" },
          { code: "469021", name: "龙湖镇" },
        ],
      },
      {
        code: "469007",
        name: "东方市",
        children: [
          { code: "469007", name: "东方华侨农场" },
          { code: "469007", name: "东河镇" },
          { code: "469007", name: "江边乡" },
          { code: "469007", name: "新龙镇" },
          { code: "469007", name: "国营广坝农场" },
          { code: "469007", name: "天安乡" },
          { code: "469007", name: "感城镇" },
          { code: "469007", name: "三家镇" },
          { code: "469007", name: "板桥镇" },
          { code: "469007", name: "四更镇" },
          { code: "469007", name: "大田镇" },
          { code: "469007", name: "八所镇" },
        ],
      },
      {
        code: "460300",
      ...
      },
      {
        ...
        name: "琼海市",
        children: [
          { code: "469002", name: "会山镇" },
          { code: "469002", name: "嘉积镇" },
          { code: "469002", name: "国营东太农场" },
          { code: "469002", name: "国营东升农场" },
          { code: "469002", name: "万泉镇" },
          { code: "469002", name: "彬村山华侨农场" },
          { code: "469002", name: "国营东红农场" },
          { code: "469002", name: "潭门镇" },
          { code: "469002", name: "大路镇" },
          { code: "469002", name: "阳江镇" },
          { code: "469002", name: "塔洋镇" },
          { code: "469002", name: "博鳌镇" },
          { code: "469002", name: "石壁镇" },
          { code: "469002", name: "龙江镇" },
          { code: "469002", name: "中原镇" },
          { code: "469002", name: "长坡镇" },
        ],
      },
      {
        code: "469026",
        name: "昌江黎族自治县",
        children: [
          { code: "469026", name: "乌烈镇" },
          { code: "469026", name: "七叉镇" },
          { code: "469026", name: "十月田镇" },
          { code: "469026", name: "国营霸王岭林场" },
          { code: "469026", name: "石碌镇" },
          { code: "469026", name: "叉河镇" },
          { code: "469026", name: "海尾镇" },
          { code: "469026", name: "海南矿业联合有限公司" },
          { code: "469026", name: "王下乡" },
          { code: "469026", name: "昌化镇" },
          { code: "469026", name: "国营红林农场" },
        ],
      },
      {
        code: "469027",
        name: "乐东黎族自治县",
        children: [
          { code: "469027", name: "莺歌海镇" },
          { code: "469027", name: "国营保国农场" },
          { code: "469027", name: "万冲镇" },
          { code: "469027", name: "国营山荣农场" },
          { code: "469027", name: "九所镇" },
          { code: "469027", name: "抱由镇" },
          { code: "469027", name: "利国镇" },
          { code: "469027", name: "国营乐光农场" },
          { code: "469027", name: "大安镇" },
          { code: "469027", name: "佛罗镇" },
          { code: "469027", name: "国营莺歌海盐场" },
          { code: "469027", name: "黄流镇" },
          { code: "469027", name: "志仲镇" },
          { code: "469027", name: "尖峰镇" },
          { code: "469027", name: "国营尖峰岭林业公司" },
          { code: "469027", name: "千家镇" },
        ],
      },
      {
        code: "469022",
        name: "屯昌县",
        children: [
          { code: "469022", name: "国营中建农场" },
          { code: "469022", name: "屯城镇" },
          { code: "469022", name: "南吕镇" },
          { code: "469022", name: "新兴镇" },
          { code: "469022", name: "国营中坤农场" },
          { code: "469022", name: "坡心镇" },
          { code: "469022", name: "西昌镇" },
          { code: "469022", name: "枫木镇" },
          { code: "469022", name: "南坤镇" },
          { code: "469022", name: "乌坡镇" },
        ],
      },
      {
        code: "469025",
        name: "白沙黎族自治县",
        children: [
          { code: "469025", name: "七坊镇" },
          { code: "469025", name: "金波乡" },
          { code: "469025", name: "南开乡" },
          { code: "469025", name: "荣邦乡" },
          { code: "469025", name: "青松乡" },
          { code: "469025", name: "国营龙江农场" },
          { code: "469025", name: "邦溪镇" },
          { code: "469025", name: "细水乡" },
          { code: "469025", name: "牙叉镇" },
          { code: "469025", name: "元门乡" },
          { code: "469025", name: "国营白沙农场" },
          { code: "469025", name: "打安镇" },
          { code: "469025", name: "阜龙乡" },
          { code: "469025", name: "国营邦溪农场" },
        ],
      },
      {
        code: "469030",
        name: "琼中黎族苗族自治县",
        children: [
          { code: "469030", name: "什运乡" },
          { code: "469030", name: "吊罗山乡" },
          { code: "469030", name: "和平镇" },
          { code: "469030", name: "国营阳江农场" },
          { code: "469030", name: "湾岭镇" },
          { code: "469030", name: "国营加钗农场" },
          { code: "469030", name: "上安乡" },
          { code: "469030", name: "营根镇" },
          { code: "469030", name: "国营乌石农场" },
          { code: "469030", name: "国营黎母山林业公司" },
          { code: "469030", name: "中平镇" },
          { code: "469030", name: "长征镇" },
          { code: "469030", name: "国营长征农场" },
          { code: "469030", name: "黎母山镇" },
          { code: "469030", name: "红毛镇" },
        ],
      },
      {
        code: "469028",
        name: "陵水黎族自治县",
        children: [
          { code: "469028", name: "椰林镇" },
          { code: "469028", name: "文罗镇" },
          { code: "469028", name: "新村镇" },
          { code: "469028", name: "黎安镇" },
          { code: "469028", name: "国营吊罗山林业公司" },
          { code: "469028", name: "国营南平农场" },
          { code: "469028", name: "本号镇" },
          { code: "469028", name: "提蒙乡" },
          { code: "469028", name: "光坡镇" },
          { code: "469028", name: "群英乡" },
          { code: "469028", name: "三才镇" },
          { code: "469028", name: "隆广镇" },
          { code: "469028", name: "国营岭门农场" },
          { code: "469028", name: "英州镇" },
        ],
      },
      {
        code: "469006",
        name: "万宁市",
        children: [
          { code: "469006", name: "后安镇" },
          { code: "469006", name: "万城镇" },
          { code: "469006", name: "国营东和农场" },
          { code: "469006", name: "礼纪镇" },
          { code: "469006", name: "国营东兴农场" },
          { code: "469006", name: "山根镇" },
          { code: "469006", name: "大茂镇" },
          { code: "469006", name: "和乐镇" },
          { code: "469006", name: "三更罗镇" },
          { code: "469006", name: "龙滚镇" },
          { code: "469006", name: "兴隆华侨农场" },
          { code: "469006", name: "长丰镇" },
          { code: "469006", name: "国营新中农场" },
          { code: "469006", name: "北大镇" },
          { code: "469006", name: "地方国营六连林场" },
          { code: "469006", name: "南桥镇" },
          { code: "469006", name: "东澳镇" },
        ],
      },
      {
        code: "469005",
        name: "文昌市",
        children: [
          { code: "469005", name: "国营罗豆农场" },
          { code: "469005", name: "东阁镇" },
          { code: "469005", name: "文教镇" },
          { code: "469005", name: "会文镇" },
          { code: "469005", name: "国营东路农场" },
          { code: "469005", name: "锦山镇" },
          { code: "469005", name: "龙楼镇" },
          { code: "469005", name: "铺前镇" },
          { code: "469005", name: "国营南阳农场" },
          { code: "469005", name: "东郊镇" },
          { code: "469005", name: "翁田镇" },
          { code: "469005", name: "冯坡镇" },
          { code: "469005", name: "昌洒镇" },
          { code: "469005", name: "公坡镇" },
          { code: "469005", name: "抱罗镇" },
          { code: "469005", name: "东路镇" },
          { code: "469005", name: "潭牛镇" },
          { code: "469005", name: "蓬莱镇" },
          { code: "469005", name: "文城镇" },
          { code: "469005", name: "重兴镇" },
        ],
      },
      {
        code: "469023",
        name: "澄迈县",
        children: [
          { code: "469023", name: "福山镇" },
          { code: "469023", name: "永发镇" },
          { code: "469023", name: "金江镇" },
          { code: "469023", name: "桥头镇" },
          { code: "469023", name: "中兴镇" },
          { code: "469023", name: "文儒镇" },
          { code: "469023", name: "老城镇" },
          { code: "469023", name: "国营红岗农场" },
          { code: "469023", name: "瑞溪镇" },
          { code: "469023", name: "国营红光农场" },
          { code: "469023", name: "大丰镇" },
          { code: "469023", name: "国营金安农场" },
          { code: "469023", name: "仁兴镇" },
          { code: "469023", name: "加乐镇" },
          { code: "469023", name: "国营和岭农场" },
          { code: "469023", name: "国营西达农场" },
          { code: "469023", name: "国营昆仑农场" },
        ],
      },
      {
        code: "460200",
      ...
      },
      {
        ...
        name: "保亭黎族苗族自治县",
        children: [
          { code: "469029", name: "海南保亭热带作物研究所" },
          { code: "469029", name: "加茂镇" },
          { code: "469029", name: "新政镇" },
          { code: "469029", name: "国营金江农场" },
          { code: "469029", name: "国营新星农场" },
          { code: "469029", name: "南林乡" },
          { code: "469029", name: "保城镇" },
          { code: "469029", name: "国营三道农场" },
          { code: "469029", name: "毛感乡" },
          { code: "469029", name: "什玲镇" },
          { code: "469029", name: "六弓乡" },
          { code: "469029", name: "响水镇" },
          { code: "469029", name: "三道镇" },
        ],
      },
      {
        code: "469001",
        name: "五指山市",
        children: [
          { code: "469001", name: "南圣镇" },
          { code: "469001", name: "毛阳镇" },
          { code: "469001", name: "水满乡" },
          { code: "469001", name: "通什镇" },
          { code: "469001", name: "畅好乡" },
          { code: "469001", name: "番阳镇" },
          { code: "469001", name: "毛道乡" },
          { code: "469001", name: "国营畅好农场" },
        ],
      },
    ],
  },
    ...
    children: [
      {
        ...
        name: "嘉峪关市",
        children: [
          { code: "620200", name: "峪泉镇" },
          { code: "620200", name: "新城镇" },
          { code: "620200", name: "文殊镇" },
          { code: "620200", name: "钢城街道" },
          { code: "620200", name: "雄关街道" },
        ],
      },
      {
        code: "620900",
...
// 升序
dataList.sort((o1, o2) => o1.code - o2.code);
dataList.forEach((item) => {
  Object.assign(item, { pId: 0, val: item.name });
  item.children.sort((o1, o2) => o1.code - o2.code);
  item.children.forEach((item1) => {
    Object.assign(item1, { pId: item.code, val: item1.name });
    item1.children.sort((o1, o2) => o1.code - o2.code);
    item1.children.forEach((item2) => {
      Object.assign(item2, { pId: item1.code, val: item2.name });
    });
  });
});

export let provList = dataList;
export let cityList = provList[0].children;
export let areaList = cityList[0].children;
